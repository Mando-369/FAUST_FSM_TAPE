...
// Test: Complex substep WITHOUT ba.if (use select2 instead)
...
with {
  ...
  // Replace ba.if with select2: select2(cond, false_val, true_val)
  dir = select2(dH >= 0.0, 0.0 - 1.0, 1.0);  // avoid literal -1.0
